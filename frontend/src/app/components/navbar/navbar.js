        ...
        if (this.state.toggled){
            return (
                <form id="search-box" className="form-inline d-flex justify-content-center">
                    <input id="search-bar" className="form-control mr-sm-2 shadow-none expand" type="search" placeholder="Search" aria-label="Search"/>
                    <button id = "search-btn" className="btn shadow-none" type="button" onClick={this.handleClick}>
                        <span id="search-icon" className= "fa fa-arrow-left"></span>
                    </button>      
                </form>
            )
        } else {
