...
const MarketingHome = () =>{
    return(
        <div id="home-page-content" className="container p-0 d-flex flex-column align-items-center">
            ...
            <div className="d-flex justify-content-center align-items-center g-0 teacherPointing">  
                <img src={teacherPointing} alt={"A teacher pointing to board"} className="col-5 col-md-4 mx-2"/>
                <p className="col-5 col-md-4 mx-2"> Pre-made activities for teachers to use, edit, and assign, for their independent classrooms!</p>
            </div>
            <div className="d-flex justify-content-center align-items-center g-0 planet">  
                ...
                <img src={planet} alt={"A planet with a flag"} className="col-5 col-md-4 mx-2"/>
            </div>
            <div className="d-flex justify-content-center align-items-center g-0 pencils">  
                <img src={pencils} alt={"Pencils in a box"} className="col-5 col-md-4 mx-2"/>
