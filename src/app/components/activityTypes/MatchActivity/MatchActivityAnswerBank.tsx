...
const AnswerBank = ({
    ...
    const matchColumnHeight = {height: matchColumnPos ? matchColumnPos.height : null}
    return (
        <div 
            className={`match-activity-column-container${mediumWindowWidth? " full-size": " w-100"}`}
            style={{position:"relative"}}
        >
            <div 
                ref={matchColumnRef}
                className={`match-activity-columns d-flex justify-content-center${mediumWindowWidth? " full-size": " w-100"}`}
                style={matchColumnHeight}
            >
