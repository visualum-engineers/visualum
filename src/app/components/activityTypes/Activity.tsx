...
const Activity = () =>{
    //redux states
    const activityData = useSelector((state: RootState) => state.activities.data.originalData.activityData)
    const resetPopUp: any = useSelector((state: RootState) => state.activities.settings.resetPopUp)
    const userSetDnDEnabled = useSelector((state: RootState) => state.activities.settings.userSetDnDEnabled)
    const timeRemindersEnabled = useSelector((state: RootState) => state.activities.settings.timeRemindersEnabled)
    ...
    //question data
    const questionNumber = useSelector((state: RootState) => state.activities.data.clientData.present.clientAnswerData.lastQuestionSeen)
