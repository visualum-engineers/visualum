...
const observer = new IntersectionObserver((entries) => {
  for (const entry of entries) {
    ...
    const entryId = target.dataset.tapDraggableId
      ? target.dataset.tapDraggableId
      : target.dataset.tapDroppableId;
    ...
    if (entryId) currentDroppablePostion[entryId] = newBounds;
  }
 ...
 */
export default function updateDroppableRect(node: any, clearPosData = false) {
  if (clearPosData) {
