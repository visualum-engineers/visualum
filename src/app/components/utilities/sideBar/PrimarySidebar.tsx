...
const PrimarySideBar = (props: any) => {
  ...
  return (
    <>
      <div
        className={`sidebar-nav fixed-top primary-sidebar-nav ${
          props.sidebarToggle ? "sidebar-right" : "sidebar-left"
        }`}
      >
        <div
          className={`primary-sidebar-link-container${
            windowScrollY ? " sidebarScrollActive" : ""
          }`}
        >
          {props.btnType === "Discover" ? (
            <>
              ...
              />
              <NavItem
                textContent={"Account Type"}
                sidebar={"primary"}
                url={"/"}
              />
              <NavItem
                textContent={"Visualum News"}
                sidebar={"primary"}
                url={"/"}
              />
