...
export default function DashboardClass() {
    ...
    const classData = [
        { id: 1, name: "Mrs. Teacher's 4th Period Class", description: "American History" },
        { id: 2, name: "Mrs. Teacher's 8th Period Class", description: "Chemistry" },
            ...
            <div className="control-bar">
                <div className="buttons">
                    <button className="btn btn-success button" onClick={openModal}>
                        <span className="pe-1"><FontAwesomeIcon icon={faPlus} /></span> Create New Class
                    </button>
                </div>
            </div>
